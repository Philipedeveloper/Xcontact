...
namespace Xcontact
{
    ...
    public sealed partial class App : Application
    {
        ...
        /// </summary>
        /// 
        public static string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "xcontactos.sqlite"));//DBNAME
        public App()
        {
            this.InitializeComponent();
            //verifica exists db
            if(!CheckFileExists("xcontactos.sqlite").Result)
            {
